...
func newOperands(v interface{}) (*Operands, error) {
	if v == nil {
		return newOperandsInt64(int64(0)), nil
	}
	...
	case float32, float64:
		return nil, fmt.Errorf("i18n: floats should be formatted into a string")
	default:
		return nil, fmt.Errorf("i18n: invalid type %T; expected integer or string", v)
	}
}
